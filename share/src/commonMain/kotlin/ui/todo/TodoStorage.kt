...
class TodoStorage(storageView : RenderView<TodoWish, TodoState>): Storage<TodoStorage.TodoWish, TodoStorage.TodoState, TodoStorage.TodoEffect>(
    renderView = storageView,
    initState = TodoState(""),
    actor = TodoActor(),
    reducer = TodoReducer()
){
